...
sub simulate_test 
{
  ...
  my ($test) = @_;
   {   
    ...
    {
      system("xrun -access +rwc -f compile_list.f -svseed $seed +UVM_TESTNAME=$test  +define+UVM_REPORT_DISABLE_FILE_LINE -coverage all -covdut zmc_axi4_top  -covworkdir /cov_work -covoverwrite -covfile ./cov_files/cov_cmd.cf -uvmhome CDNS-1.1d"); 
    }
    else
    {  
